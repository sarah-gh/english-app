  ...
  <div>
    ...
    >
      ...
      <button
        ...
        class="absolute inset-x-0 bottom-0 flex h-16 items-end justify-center gap-1 bg-linear-to-t from-black to-transparent pb-1.5 text-xs font-medium text-text/60 hover:text-primary"
        :class="fadeClass"
        @pointerdown.stop
