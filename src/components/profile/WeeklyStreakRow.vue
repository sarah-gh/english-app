...
<template>
  <div class="rounded-2xl border border-slate-600 bg-card-surface p-4">
    <div class="mb-3 flex items-center justify-between">
      <p class="text-sm font-semibold text-text">This Week</p>
    ...
    <div class="flex justify-between gap-1">
      <div v-for="day in analyticsStore.weekStreak" :key="day.date" class="flex flex-col items-center gap-1.5">
        <div
class="flex h-10 w-10 items-center justify-center rounded-full text-xs font-semibold transition-colors" :class="[
          day.cardsStudied > 0
